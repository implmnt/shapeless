...
Builds are available for Scala 2.10.x, 2.11.x, 2.12.x and for 2.13.0. The main line of development for
...
shapeless is built with SBT 0.13.16 or later, and its master branch is built with Scala 2.13.0 by default but also
